...
<head>
    ...
    <meta name="description" content="DIU Routes – Student Panel, Dhaka International University live bus tracker." />
...
<body>
    ...
    <nav id="navbar" role="navigation" aria-label="User panel navigation">
        ...
        <!-- Logo -->
        <a href="{{ route('student.dashboard') }}" class="nav-logo" aria-label="DIU Routes Home">
            <div class="logo-icon">
        ...
        <div class="nav-controls">
            ...
            <div style="position:relative;" id="user-wrapper">
                ...
                <div class="dropdown user-dropdown" id="user-dropdown" role="menu">
                    ...
                    <!-- Menu items -->
                    <div class="dd-menu">
                        <a href="{{ route('student.profile') }}" class="dd-item" role="menuitem">
                            <i class="fa-regular fa-user"></i> My Profile
                        </a>
                        <a href="{{ route('student.settings') }}" class="dd-item" role="menuitem">
                        ...
                        <a href="{{ route('student.logout') }}" class="dd-item danger" role="menuitem">
